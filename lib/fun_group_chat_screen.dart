...
class _FunGroupChatScreenState extends State<FunGroupChatScreen> {
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      await _sendFunGroupChatNotifications(text);
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Text('Active Users in Fun Chat', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
            ),
            const Padding(
  ...
  Future<void> _sendFunGroupChatNotifications(String messageText) async {
    try {
      ...
      final activeUsers = _activeUserIds.where((userId) => userId != widget.userId).toList();
      
      print('Sending fun group chat notifications to ${activeUsers.length} users');
      ...
      for (final userId in activeUsers) {
        try {
          ...
          print('✅ Fun group chat notification sent to user: $userId');
        } catch (e) {
          print('❌ Error sending fun group chat notification to user $userId: $e');
        }
      }
    } catch (e) {
      print('❌ Error in _sendFunGroupChatNotifications: $e');
    }
  }
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  userName,
                                                  style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: nameFont),
                                      ...
                                      Align(
                                        ...
                                        child: Text(
                                          msg['timestamp'] != null && msg['timestamp'] is Timestamp
                                              ...
                                              : '',
                                          style: TextStyle(color: Colors.white54, fontSize: timeFont),
                                        ),
                                      ),
                                    ],
                                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: IconButton(
                          icon: Icon(Icons.emoji_emotions, color: Colors.white70, size: isSmall ? 20 : 24),
